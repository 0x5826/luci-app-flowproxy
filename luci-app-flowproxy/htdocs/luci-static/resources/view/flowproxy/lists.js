...
return L.view.extend({
    ...
    addSaveApplyButton: function(s) {
        ...
        o.onclick = L.bind(function(ev, section_id) {
            return this.map.save().then(function() {
                ...
                ui.hideModal();
                ui.addNotification(null, E('p', _('Failed to apply changes: %s').format(e.message || e)), 'danger');
            });
        }, this);
    },
    ...
    render: function() {
        ...
        o.rmempty = false;
        o.default = '1';
        o = s.option(form.Flag, 'auto_generate', _('Auto Generate'), _('Automatically manage private ranges (RFC 1918).'));
        o.default = '1';
